    ...
    return (
        ...
        <aside className="flex flex-col h-full w-full bg-zinc-50 dark:bg-zinc-950 border-r border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-100 font-sans">
            ...
            <div className="p-3 border-t border-zinc-200 dark:border-zinc-800 shrink-0">
                <button className="flex items-center justify-between w-full rounded-xl p-2 hover:bg-zinc-200/50 dark:hover:bg-zinc-800/50 transition-colors">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col items-start text-sm">
                            <span className="font-medium text-zinc-900 dark:text-zinc-100">Pro User</span>
                            <span className="text-xs text-zinc-500 dark:text-zinc-400">Settings</span>
                        </div>
                    </div>
